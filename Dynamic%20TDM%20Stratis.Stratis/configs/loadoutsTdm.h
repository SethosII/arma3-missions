...
class B_soldier_AR_F {
	...
	magazines[] = {"16Rnd_9x21_Mag","100Rnd_65x39_caseless_mag","100Rnd_65x39_caseless_mag","100Rnd_65x39_caseless_mag","100Rnd_65x39_caseless_mag","100Rnd_65x39_caseless_mag","100Rnd_65x39_caseless_mag","16Rnd_9x21_Mag","HandGrenade","HandGrenade","SmokeShell","SmokeShellGreen","Chemlight_green","Chemlight_green"};
	items[] = {"FirstAidKit"};
	linkedItems[] = {"V_PlateCarrier2_rgr","H_HelmetB_grass","G_Tactical_Clear","ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS","NVGoggles"};
};
class B_soldier_smg_F {
	displayName = "Rifleman (SMG)";
	icon = "\A3\ui_f\data\map\VehicleIcons\iconman_ca.paa";
	uniformClass = "U_B_CombatUniform_mcam";
	backpack = "";
	weapons[] = {"SMG_01_Holo_F","hgun_P07_F","Throw","Put"};
	magazines[] = {"30Rnd_45ACP_Mag_SMG_01","30Rnd_45ACP_Mag_SMG_01","30Rnd_45ACP_Mag_SMG_01","30Rnd_45ACP_Mag_SMG_01","Chemlight_green","30Rnd_45ACP_Mag_SMG_01","SmokeShellGreen","SmokeShellBlue","SmokeShellOrange","Chemlight_green","16Rnd_9x21_Mag","16Rnd_9x21_Mag","16Rnd_9x21_Mag","30Rnd_45ACP_Mag_SMG_01","30Rnd_45ACP_Mag_SMG_01","30Rnd_45ACP_Mag_SMG_01"};
	items[] = {"FirstAidKit"};
	linkedItems[] = {"V_BandollierB_khk","H_HelmetB_light_snakeskin","G_Tactical_Clear","ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS","NVGoggles"};
};
class B_soldier_M_F {
...
class B_special_F {
	...
	backpack = "";
	weapons[] = {"srifle_DMR_02_sniper_AMS_LP_S_F","hgun_Rook40_F","Binocular","Throw","Put"};
	magazines[] = {"Chemlight_green","Chemlight_green","SmokeShellGreen","SmokeShell","16Rnd_9x21_Mag","16Rnd_9x21_Mag","16Rnd_9x21_Mag","10Rnd_338_Mag","10Rnd_338_Mag","10Rnd_338_Mag","10Rnd_338_Mag","10Rnd_338_Mag","10Rnd_338_Mag","HandGrenade","HandGrenade","B_IR_Grenade"};
	items[] = {"FirstAidKit"};
	linkedItems[] = {"V_PlateCarrierGL_blk","H_HelmetB_camo","G_Balaclava_combat","ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS","NVGoggles"};
};
...
class O_soldier_smg_F {
	displayName = "Rifleman (SMG)";
	icon = "\A3\ui_f\data\map\VehicleIcons\iconman_ca.paa";
	uniformClass = "U_O_CombatUniform_ocamo";
	backpack = "";
	weapons[] = {"SMG_02_ACO_F","hgun_Rook40_F","Throw","Put"};
	magazines[] = {"30Rnd_9x21_Mag","30Rnd_9x21_Mag","30Rnd_9x21_Mag","30Rnd_9x21_Mag","30Rnd_9x21_Mag","30Rnd_9x21_Mag","30Rnd_9x21_Mag","30Rnd_9x21_Mag","Chemlight_red","Chemlight_red","16Rnd_9x21_Mag","16Rnd_9x21_Mag","16Rnd_9x21_Mag"};
	items[] = {"FirstAidKit"};
	linkedItems[] = {"V_BandollierB_cbr","H_HelmetSpecO_ocamo","G_Tactical_Clear","ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS","NVGoggles_OPFOR"};
};
class O_Soldier_M_F {
	displayName = "Marksman";
	icon = "\A3\ui_f\data\map\VehicleIcons\iconman_ca.paa";
...
class O_special_F {
	...
	backpack = "";
	weapons[] = {"srifle_DMR_05_DMS_snds_F","hgun_Rook40_F","Binocular","Throw","Put"};
	magazines[] = {"Chemlight_red","16Rnd_9x21_Mag","16Rnd_9x21_Mag","16Rnd_9x21_Mag","SmokeShell","SmokeShellRed","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","10Rnd_93x64_DMR_05_Mag","HandGrenade","HandGrenade"};
	items[] = {"FirstAidKit"};
	linkedItems[] = {"V_TacVestIR_blk","H_HelmetLeaderO_oucamo","G_Tactical_Clear","ItemMap","ItemCompass","ItemWatch","ItemRadio","ItemGPS","NVGoggles_OPFOR"};
};
